        ...
        ((e = (function (e) {
            ...
            function s(e, t) {
                ...
                if (
                    ...
                    (n =
                        null != (o = s.optionsForElement(this.element))
                            ? o
                            : {}),
                    (this.options = i(
                        {},
            ...
            return (
                    ...
                    addedfile: function (e) {
                        ...
                        if (
                            ...
                            for (
                                ...
                                (i = c[o]),
                                    h.push(i.addEventListener("click", t));
                            return h;
                        }
                    },
                ...
                (s.prototype.filesize = function (e) {
                    ...
                    for (
                        ...
                        if (
                            ((s = r[t]),
                            e >=
                                Math.pow(this.options.filesizeBase, 4 - t) / 10)
                        ) {
                            (i =
                        ...
                        ((n = document.createElement("img")).onload =
                            ...
                            function () {
                                ...
                                if (
                                    ...
                                    (e.height = n.height),
                                    null ==
                                        (l = s.options.resize.call(s, e))
                                            .trgWidth &&
                                        (l.trgWidth = l.optWidth),
                                    null == l.trgHeight &&
                                        (l.trgHeight = l.optHeight),
                                    (o = (t =
                ...
                (s.prototype.cancelUpload = function (e) {
                    ...
                    if (e.status === s.UPLOADING) {
                        for (
                            n = 0,
                                o = (i = this._getFilesWithXhr(e.xhr)).length;
                            n < o;
                            n++
                        )
                ...
                (s.prototype.uploadFiles = function (e) {
                    var t,
                        ...
                        R;
                    for (
                        E = new XMLHttpRequest(), b = 0, L = e.length;
                        b < L;
                        b++
                    )
                        (t = e[b]).xhr = E;
                            ...
                            (t = e[i]),
                                s.push(
                                    R._errorProcessing(
                                        e,
                                        v ||
                                            R.options.dictResponseError.replace(
                                                "{{statusCode}}",
                                                E.status
                                            ),
                                        E
                    ...
                    (y = (function (i) {
                        return function (n) {
                            ...
                            if (null != n)
                                ...
                                for (
                                    s = !0, r = 100, l = 0, p = e.length;
                                    l < p;
                                    l++
                                )
                                    (100 === (t = e[l]).upload.progress &&
                                        t.upload.bytesSent ===
                                            t.upload.total) ||
                                        (s = !1),
                                        (t.upload.progress = r),
                    ...
                    if (((r = new FormData()), this.options.params))
                        for (m in (_ = this.options.params))
                            (w = _[m]), r.append(m, w);
                    for (C = 0, x = e.length; C < x; C++)
                        (t = e[C]), this.emit("sending", t, E, r);
                    if (
                        (this.options.uploadMultiple &&
                            this.emit("sendingmultiple", e, E, r),
                        "FORM" === this.element.tagName)
                    )
                        for (
                            k = 0,
                                T = (M = this.element.querySelectorAll(
                            ...
                            if (
                                ((c = (d = M[k]).getAttribute("name")),
                                (h = d.getAttribute("type")),
                                "SELECT" === d.tagName &&
                                    d.hasAttribute("multiple"))
                            )
                                for (
                                    z = 0, A = (U = d.options).length;
                                    z < A;
                                    z++
                                )
                                    (g = U[z]).selected && r.append(c, g.value);
                            else
                                (!h ||
                                    ("checkbox" !== (N = h.toLowerCase()) &&
                                        "radio" !== N) ||
                                    d.checked) &&
                                    r.append(c, d.value);
                    for (
        ...
        (e.isBrowserSupported = function () {
            ...
            if (
                ...
                if ("classList" in document.createElement("a"))
                    for (
                        i = 0, n = (s = e.blacklistedBrowsers).length;
                        i < n;
                        i++
                    )
                        s[i].test(navigator.userAgent) && (t = !1);
                else t = !1;
            else t = !1;
            return t;
        }),
